<template>
    <div class="login">
        <div class="content">
            <div>
                <div class="mat-in">
                    <input v-model="username" type="text" name="username" value="" required></input>
                    <span class="bar"></span>
                    <label>用户名</label>
                </div>
                <div class="mat-in">
                    <input v-model="password" type="password" name="password" value="" required></input>
                    <span class="bar"></span>
                    <label>密码</label>
                </div>
